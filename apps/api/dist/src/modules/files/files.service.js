    ...
    async findAll(workspaceId, userId, filters) {
        ...
        if (userId) {
            ...
            if (workspaceIds.length > 0) {
                conditions.push((0, drizzle_orm_1.inArray)(schema_1.files.workspaceId, workspaceIds));
            }
            else {
                return [];
            }
        ...
        return this.db.select().from(schema_1.files).orderBy((0, drizzle_orm_1.desc)(schema_1.files.createdAt));
    }
