...
exports.workspaces = (0, pg_core_1.pgTable)('workspaces', {
    ...
    billingBudgetUsd: (0, pg_core_1.decimal)('billing_budget_usd', { precision: 10, scale: 2 }).default('0'),
    billingAlertThresholds: (0, pg_core_1.integer)('billing_alert_thresholds').array().default([50, 75, 90, 100]),
    billingActionOnLimit: (0, pg_core_1.varchar)('billing_action_on_limit', { length: 50 }).default('notify_only'),
...
exports.files = (0, pg_core_1.pgTable)('files', {
    ...
    url: (0, pg_core_1.varchar)('url', { length: 500 }),
    aiProcessed: (0, pg_core_1.boolean)('ai_processed').default(false),
    aiSummary: (0, pg_core_1.text)('ai_summary'),
    tags: (0, pg_core_1.text)('tags').array(),
    uploadedBy: (0, pg_core_1.uuid)('uploaded_by').notNull().references(() => exports.users.id),
    createdAt: (0, pg_core_1.timestamp)('created_at', { withTimezone: true }).defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at', { withTimezone: true }).defaultNow(),
});
exports.memory = (0, pg_core_1.pgTable)('memory', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    workspaceId: (0, pg_core_1.uuid)('workspace_id').notNull().references(() => exports.workspaces.id, { onDelete: 'cascade' }),
    userId: (0, pg_core_1.uuid)('user_id').notNull().references(() => exports.users.id, { onDelete: 'cascade' }),
    type: (0, exports.memoryType)('type').notNull(),
    key: (0, pg_core_1.varchar)('key', { length: 255 }).notNull(),
    value: (0, pg_core_1.jsonb)('value').notNull(),
    source: (0, exports.memorySource)('source').notNull().default('explicit'),
    createdAt: (0, pg_core_1.timestamp)('created_at', { withTimezone: true }).defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at', { withTimezone: true }).defaultNow(),
});
exports.integrations = (0, pg_core_1.pgTable)('integrations', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    workspaceId: (0, pg_core_1.uuid)('workspace_id').notNull().references(() => exports.workspaces.id, { onDelete: 'cascade' }),
    provider: (0, exports.integrationProvider)('provider').notNull(),
    status: (0, exports.integrationStatus)('status').notNull().default('disconnected'),
    config: (0, pg_core_1.jsonb)('config').default({}),
    accessToken: (0, pg_core_1.varchar)('access_token', { length: 500 }),
    refreshToken: (0, pg_core_1.varchar)('refresh_token', { length: 500 }),
    syncStatus: (0, exports.integrationStatus)('sync_status').default('disconnected'),
    lastSyncedAt: (0, pg_core_1.timestamp)('last_synced_at', { withTimezone: true }),
    createdAt: (0, pg_core_1.timestamp)('created_at', { withTimezone: true }).defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at', { withTimezone: true }).defaultNow(),
});
exports.workspaceAgents = (0, pg_core_1.pgTable)('workspace_agents', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    workspaceId: (0, pg_core_1.uuid)('workspace_id').notNull().references(() => exports.workspaces.id, { onDelete: 'cascade' }),
    agentId: (0, pg_core_1.uuid)('agent_id').notNull().references(() => exports.agents.id, { onDelete: 'cascade' }),
    installedBy: (0, pg_core_1.uuid)('installed_by').notNull().references(() => exports.users.id),
    installedAt: (0, pg_core_1.timestamp)('installed_at', { withTimezone: true }).defaultNow(),
});
